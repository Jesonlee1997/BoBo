...
import me.jesonlee.bobo.exception.NoClassScannedException;
import me.jesonlee.bobo.util.StringUtil;
...
public class ClasspathPackageScanner implements PackageScanner {
    ...
    public static void main(String[] args) throws Exception {
        PackageScanner scan = new ClasspathPackageScanner("me.jesonlee.bobo.core");
    }
